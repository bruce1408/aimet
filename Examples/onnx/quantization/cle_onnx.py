...
visualize_onnx_model_weights(filename, model_name="resnet18_origin", results_dir="/mnt/share_disk/bruce_trie/workspace/logs_aimet/resnet18_origin")
...
accuracy = ImageNetDataPipeline.evaluate(sim.session)
print("onnx acc is: ", accuracy)
visualize_onnx_model_weights(filename, model_name="resnet18_origin", results_dir="/mnt/share_disk/bruce_trie/workspace/logs_aimet/resnet18_cle")
